    ...
    def output_employee_data(employee_data: list):
        ...
        for employee in employee_data:
            if employee.review_rating == 5:
                message = " {} {} reviewed on {} and rated as {} (Leading)"
            elif employee.review_rating == 4:
                message = " {} {} reviewed on {} and rated as {} (Strong)"
            elif employee.review_rating == 3:
                message = " {} {} reviewed on {} and rated as {} (Solid)"
            elif employee.review_rating == 2:
                message = " {} {} reviewed on {} and rated as (Building)"
            elif employee.review_rating == 1:
                message = " {} {} reviewed on {} and rated as {} (Not Meeting Expectations)"
